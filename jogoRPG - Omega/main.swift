...
func Mercado() throws{
    let ListaMercado = ["Cajado do Abismo,3500", "Livro de Sangue,4000", "Pocao de Cura,50", "Pocao de Mana,100"]
    ...
    {
        listaMercado_temp = ListaMercado[temp].components(separatedBy: ",")
